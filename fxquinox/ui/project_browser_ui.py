...
class Ui_project_browser(object):
    def setupUi(self, project_browser):
        if not project_browser.objectName():
            project_browser.setObjectName(u"project_browser")
        project_browser.resize(2067, 852)
        self.verticalLayout_7 = QVBoxLayout(project_browser)
        self.verticalLayout_7.setObjectName(u"verticalLayout_7")
        self.frame_project = QFrame(project_browser)
        ...
        self.frame_project.setFrameShape(QFrame.StyledPanel)
        self.frame_project.setFrameShadow(QFrame.Raised)
        ...
        self.splitter = QSplitter(project_browser)
        ...
        self.frame_filter_assets.setFrameShape(QFrame.StyledPanel)
        self.frame_filter_assets.setFrameShadow(QFrame.Raised)
        ...
        self.checkbox_display_latest_worfiles = QCheckBox(self.frame)
        self.checkbox_display_latest_worfiles.setObjectName(u"checkbox_display_latest_worfiles")

        self.horizontalLayout_4.addWidget(self.checkbox_display_latest_worfiles)
        ...
        self.retranslateUi(project_browser)

        self.tab_assets_shots.setCurrentIndex(1)


        QMetaObject.connectSlotsByName(project_browser)
    # setupUi

    def retranslateUi(self, project_browser):
        project_browser.setWindowTitle(QCoreApplication.translate("project_browser", u"Form", None))
        self.label_project.setText(QCoreApplication.translate("project_browser", u"Project", None))
        self.label_icon_filter_assets.setText(QCoreApplication.translate("project_browser", u"Icon", None))
        self.line_edit_filter_assets.setPlaceholderText(QCoreApplication.translate("project_browser", u"Filter...", None))
        self.tab_assets_shots.setTabText(self.tab_assets_shots.indexOf(self.tab_assets), QCoreApplication.translate("project_browser", u"Assets", None))
        self.label_icon_filter_shots.setText(QCoreApplication.translate("project_browser", u"Icon", None))
        self.line_edit_filter_shots.setPlaceholderText(QCoreApplication.translate("project_browser", u"Filter...", None))
        self.tab_assets_shots.setTabText(self.tab_assets_shots.indexOf(self.tab_shots), QCoreApplication.translate("project_browser", u"Shots", None))
        self.group_box_steps.setTitle(QCoreApplication.translate("project_browser", u"Steps", None))
        self.group_box_tasks.setTitle(QCoreApplication.translate("project_browser", u"Tasks", None))
        self.group_box_info.setTitle(QCoreApplication.translate("project_browser", u"Metadata", None))
        self.group_box_workfiles.setTitle(QCoreApplication.translate("project_browser", u"Workfiles", None))
        self.checkbox_display_latest_worfiles.setText(QCoreApplication.translate("project_browser", u"Show Only Latest", None))
        self.label_icon_filter_workfiles.setText(QCoreApplication.translate("project_browser", u"Icon", None))
        self.combobox_filter_workfiles.setItemText(0, QCoreApplication.translate("project_browser", u"All", None))
        self.combobox_filter_workfiles.setItemText(1, QCoreApplication.translate("project_browser", u"Blender", None))
        self.combobox_filter_workfiles.setItemText(2, QCoreApplication.translate("project_browser", u"Houdini", None))
        self.combobox_filter_workfiles.setItemText(3, QCoreApplication.translate("project_browser", u"Maya", None))
        self.combobox_filter_workfiles.setItemText(4, QCoreApplication.translate("project_browser", u"Nuke", None))
        self.combobox_filter_workfiles.setItemText(5, QCoreApplication.translate("project_browser", u"Photoshop", None))
        self.combobox_filter_workfiles.setItemText(6, QCoreApplication.translate("project_browser", u"Substance Painter", None))

        ___qtreewidgetitem = self.tree_widget_workfiles.headerItem()
        ___qtreewidgetitem.setText(6, QCoreApplication.translate("project_browser", u"Size", None));
        ___qtreewidgetitem.setText(5, QCoreApplication.translate("project_browser", u"User", None));
        ___qtreewidgetitem.setText(4, QCoreApplication.translate("project_browser", u"Date Modified", None));
        ___qtreewidgetitem.setText(3, QCoreApplication.translate("project_browser", u"Date Created", None));
        ___qtreewidgetitem.setText(2, QCoreApplication.translate("project_browser", u"Comment", None));
        ___qtreewidgetitem.setText(1, QCoreApplication.translate("project_browser", u"Version", None));
    # retranslateUi
